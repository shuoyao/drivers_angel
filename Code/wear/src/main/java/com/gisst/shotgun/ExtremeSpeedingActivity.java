 ...
 */
public class ExtremeSpeedingActivity extends Activity{

    long[] vibrationPattern = {0, 300, 300, 300, 300, 300, 300, 300, 300, 300, 300, 300};
    int repeat = -1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_speeding_extreme);
